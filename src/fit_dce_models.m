function [fit, params, resnorm, residual, output] = fit_dce_models (tac,scanTime,ppCp,model)
...
switch(model)
    case 'DCE_MRI 1TC'
        %         vB  sa   K1   k2    k3   k4
        par0  = [0.00  0  0.1  0.1  0.00 0.00];
        fixed = [0     1    0    0     1    1];
    case 'DCE_MRI 2TCr'
        %         vB  sa   K1   k2    k3    k4
        par0  = [0.00  1  0.1  0.1  0.001  0.001];
        fixed = [0     1    0    0     0     0];
    case 'DCE_MRI 2TCi'
        %         vB  sa   K1   k2    k3    k4
        par0  = [0.00  1  0.1  0.1  0.01  0.00];
        fixed = [0     1    0    0     0     1];
end
...
func = @(par,t) dce_models(model, par, scanTime, ppCp, 1, 0);
...
fit = dce_models(model, params, scanTime, ppCp, 1, 0);
